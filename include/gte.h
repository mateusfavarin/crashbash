...
#define gte_stir1(r0) __asm__ volatile("swc2   $9, 0( %0 )" : : "r"(r0) : "memory")

#define gte_stir2(r0) __asm__ volatile("swc2   $10, 0( %0 )" : : "r"(r0) : "memory")

#define gte_stir3(r0) __asm__ volatile("swc2   $11, 0( %0 )" : : "r"(r0) : "memory")
